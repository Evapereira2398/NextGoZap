...
routes.post('/api/:session/list-chats', verifyToken, statusConnection, DeviceController.listChats);
...
// Catalog
routes.get('/api/:session/get-products', verifyToken, statusConnection);

routes.get('/api/:session/get-product-by-id', verifyToken, statusConnection);

routes.post('/api/:session/add-product', verifyToken, statusConnection);

routes.post('/api/:session/edit-product', verifyToken, statusConnection);

routes.post('/api/:session/del-products', verifyToken, statusConnection);

routes.post('/api/:session/change-product-image', verifyToken, statusConnection);

routes.post('/api/:session/add-product-image', verifyToken, statusConnection);

routes.post('/api/:session/remove-product-image', verifyToken, statusConnection);

routes.get('/api/:session/get-collections', verifyToken, statusConnection);

routes.post('/api/:session/create-collection', verifyToken, statusConnection);

routes.post('/api/:session/edit-collection', verifyToken, statusConnection);

routes.post('/api/:session/del-collection', verifyToken, statusConnection);

routes.post('/api/:session/send-link-catalog', verifyToken, statusConnection);

routes.post('/api/:session/set-product-visibility', verifyToken, statusConnection);

routes.post('/api/:session/set-cart-enabled', verifyToken, statusConnection);
...
// Profile
routes.post('/api/:session/set-profile-pic', upload.single('file'), verifyToken, statusConnection, DeviceController.setProfilePic);
